            ...
            switch (owner) {
                case "org/bukkit/block/Block":
                    ...
                    if ("setBlockData".equals(name)) {
                        if ("(Lorg/bukkit/block/data/BlockData;Z)V".equals(desc)) return transform(2, "_bd", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/block/Block;Lorg/bukkit/block/data/BlockData;Z)V");
                ...
                case "org/bukkit/World":
                    ...
                    if ("rayTraceBlocks".equals(name) && "(Lorg/bukkit/Location;Lorg/bukkit/util/Vector;DLorg/bukkit/FluidCollisionMode;)Lorg/bukkit/util/RayTraceResult;".equals(desc)) {
                        return transform(4, "_rtb", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/util/Vector;DLorg/bukkit/FluidCollisionMode;)Lorg/bukkit/util/RayTraceResult;");
                    }
                    ...
                    if ("spawnParticle".equals(name) && "(Lorg/bukkit/Particle;Lorg/bukkit/Location;IDDDDLjava/lang/Object;)V".equals(desc)) {
                        return transform(8, "_sp", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/Particle;IDDDDLjava/lang/Object;)V");
                    }
                    break;
