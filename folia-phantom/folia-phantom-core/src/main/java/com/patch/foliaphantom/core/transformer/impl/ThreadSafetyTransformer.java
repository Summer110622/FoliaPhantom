        ...
        private boolean tryHandle(String owner, String name, String desc) {
            switch (owner) {
                ...
                case "org/bukkit/World":
                    ...
                    if ("unloadChunk".equals(name) && "(IIZ)Z".equals(desc)) {
                        return transform(3, "_cu", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;IIZ)Z");
                    }
                    ...
                    if ("spawnParticle".equals(name) && "(Lorg/bukkit/Particle;Lorg/bukkit/Location;IDDDD)V".equals(desc)) {
                        return transform(8, "_sp", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Particle;Lorg/bukkit/Location;IDDDD)V");
                    }
                    break;
                ...
                case "org/bukkit/entity/Damageable":
                    switch (name) {
                        ...
                        case "setVelocity":
                            ...
                            break;
                        case "teleport":
                            if ("(Lorg/bukkit/Location;)Z".equals(desc)) return transform(1, "_tp", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;Lorg/bukkit/Location;)Z");
                            break;
                        case "setFireTicks":
                            if ("(I)V".equals(desc)) return transform(1, "_tf", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;I)V");
                            break;
                        case "setCustomName":
                            if ("(Ljava/lang/String;)V".equals(desc)) return transform(1, "_cn", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;Ljava/lang/String;)V");
                            break;
                        case "setGravity":
                            if ("(Z)V".equals(desc)) return transform(1, "_sg", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;Z)V");
                            break;
                        case "damage":
                            if ("(D)V".equals(desc)) return transform(1, "_dm", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Damageable;D)V");
                            if ("(DLorg/bukkit/entity/Entity;)V".equals(desc)) return transform(2, "_dm", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Damageable;DLorg/bukkit/entity/Entity;)V");
                            break;
                        case "setAI":
