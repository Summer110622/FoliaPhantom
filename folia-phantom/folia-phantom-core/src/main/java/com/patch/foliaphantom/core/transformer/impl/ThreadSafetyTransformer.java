            ...
            switch (owner) {
                ...
                case "org/bukkit/World":
                    ...
                    if ("dropItemNaturally".equals(name) && "(Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;".equals(desc)) {
                        return transform(2, "_diNaturally", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;");
                    }
                    ...
                    if ("getEntities".equals(name) && "()Ljava/util/List;".equals(desc)) {
                        return transform(0, "_ge", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;)Ljava/util/List;");
                    }
                    if ("getLivingEntities".equals(name) && "()Ljava/util/List;".equals(desc)) {
                        return transform(0, "_gl", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;)Ljava/util/List;");
                    }
                    if ("getNearbyEntities".equals(name) && "(Lorg/bukkit/Location;DDD)Ljava/util/Collection;".equals(desc)) {
                        return transform(4, "_gne", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;DDD)Ljava/util/Collection;");
                    }
                ...
                case "org/bukkit/entity/Damageable":
                    switch (name) {
                        ...
                        case "removeScoreboardTag":
                            ...
                            break;
                        case "remove":
                            if ("()V".equals(desc)) return transform(0, "_rem", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;)V");
                            break;
                        case "setVelocity":
                        ...
                        case "teleport":
                            ...
                            break;
                        case "setFireTicks":
                            if ("(I)V".equals(desc)) return transform(1, "_sft", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;I)V");
                            break;
                        case "setCustomName":
                            if ("(Ljava/lang/String;)V".equals(desc)) return transform(1, "_scn", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;Ljava/lang/String;)V");
                            break;
                        case "setGravity":
                            if ("(Z)V".equals(desc)) return transform(1, "_sg", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;Z)V");
                            break;
                        case "damage":
                            if ("(D)V".equals(desc)) return transform(1, "_dmg", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Damageable;D)V");
                            if ("(DLorg/bukkit/entity/Entity;)V".equals(desc)) return transform(2, "_dmg", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Damageable;DLorg/bukkit/entity/Entity;)V");
                            break;
                        case "setAI":
                            if ("(Z)V".equals(desc)) return transform(1, "_sai", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/LivingEntity;Z)V");
                            break;
                        case "setGameMode":
                            if ("(Lorg/bukkit/GameMode;)V".equals(desc)) return transform(1, "_sgm", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Player;Lorg/bukkit/GameMode;)V");
                            break;
                        case "getHealth":
