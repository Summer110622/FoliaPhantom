        ...
        case "org/bukkit/entity/Damageable":
          switch (name) {
            ...
            case "getNearbyEntities":
              if ("(DDD)Ljava/util/List;".equals(desc)) return transform(3, "_ne", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/Entity;DDD)Ljava/util/List;");
              break;
            case "addPotionEffect":
              if ("(Lorg/bukkit/potion/PotionEffect;)Z".equals(desc)) return transform(1, "_ae", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/LivingEntity;Lorg/bukkit/potion/PotionEffect;)Z");
              break;
            case "removePotionEffect":
              if ("(Lorg/bukkit/potion/PotionEffectType;)V".equals(desc)) return transform(1, "_re", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/entity/LivingEntity;Lorg/bukkit/potion/PotionEffectType;)V");
              break;
          }
          break;
