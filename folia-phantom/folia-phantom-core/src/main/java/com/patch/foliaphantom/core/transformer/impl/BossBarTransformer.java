/*
 * Folia Phantom - BossBar Class Transformer
 *
...
public class BossBarTransformer implements ClassTransformer {
    ...
    private static class BossBarMethodVisitor extends AdviceAdapter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            if (itf && (owner.equals("org/bukkit/boss/BossBar") || owner.equals("org/bukkit/boss/KeyedBossBar"))) {
                if (name.equals("addPlayer") && desc.equals("(Lorg/bukkit/entity/Player;)V")) {
                    transform(1, "_bb_ap", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/boss/BossBar;Lorg/bukkit/entity/Player;)V");
                    return;
                }
                if (name.equals("removePlayer") && desc.equals("(Lorg/bukkit/entity/Player;)V")) {
                    transform(1, "_bb_rp", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/boss/BossBar;Lorg/bukkit/entity/Player;)V");
                    return;
                }
                if (name.equals("removeAll") && desc.equals("()V")) {
                    transform(0, "_bb_ra", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/boss/BossBar;)V");
                    return;
                }
            }
