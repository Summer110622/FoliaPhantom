...
public class WorldAccessTransformer implements ClassTransformer {
    ...
    private static class WorldAccessMethodVisitor extends AdviceAdapter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean isInterface) {
            if ("org/bukkit/World".equals(owner) && tryHandleWorld(name, desc)) {
                return;
            }
            super.visitMethodInsn(opcode, owner, name, desc, isInterface);
        }

        private boolean tryHandleWorld(String name, String desc) {
            switch (name) {
                case "getBlockAt":
                    ...
                    break;
                case "spawnEntity":
                    if ("(Lorg/bukkit/Location;Lorg/bukkit/entity/EntityType;)Lorg/bukkit/entity/Entity;".equals(desc)) return transform(2, "safeSpawnEntity", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/entity/EntityType;)Lorg/bukkit/entity/Entity;");
                    break;
                case "spawn":
                     if ("(Lorg/bukkit/Location;Ljava/lang/Class;)Lorg/bukkit/entity/Entity;".equals(desc)) return transform(2, "safeSpawnEntity", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Ljava/lang/Class;)Lorg/bukkit/entity/Entity;");
                    break;
                case "dropItem":
                    if ("(Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;".equals(desc)) return transform(2, "safeDropItem", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;");
                    break;
                case "dropItemNaturally":
                    if ("(Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;".equals(desc)) return transform(2, "safeDropItemNaturally", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/inventory/ItemStack;)Lorg/bukkit/entity/Item;");
                    break;
                case "strikeLightning":
                    if ("(Lorg/bukkit/Location;)Lorg/bukkit/entity/LightningStrike;".equals(desc)) return transform(1, "safeStrikeLightning", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;)Lorg/bukkit/entity/LightningStrike;");
                    break;
                case "generateTree":
                    if ("(Lorg/bukkit/Location;Lorg/bukkit/TreeType;)Z".equals(desc)) return transform(2, "safeGenerateTree", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;Lorg/bukkit/TreeType;)Z");
                    break;
                case "createExplosion":
                    if ("(Lorg/bukkit/Location;F)Z".equals(desc)) return transform(2, "safeCreateExplosion", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;F)Z");
                    break;
                case "getHighestBlockYAt":
                    if ("(Lorg/bukkit/Location;)I".equals(desc)) return transform(1, "safeGetHighestBlockYAt", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;Lorg/bukkit/Location;)I");
                    break;
                case "loadChunk":
                    if ("(IIZ)V".equals(desc)) return transform(3, "safeLoadChunk", "(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/World;IIZ)V");
                    break;
            }
            return false;
        }
